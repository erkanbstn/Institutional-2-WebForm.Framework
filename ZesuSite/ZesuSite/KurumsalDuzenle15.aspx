<%@ Page Title="" Language="C#" MasterPageFile="~/ZesuAdmin.Master" AutoEventWireup="true" CodeBehind="KurumsalDuzenle15.aspx.cs" Inherits="ZesuSite.KurumsalDuzenle15" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <br />
    <br />
    <h2 style="color: purple">SPORCU ÜRÜN GÖRSELLERİ</h2>
    <br />
